...
get f(){
  ...
  losubmit(){
    ...
    this.dataStore.saveLogin({

      firstName: this.form.get('loginName')?.value,
...
form!:FormGroup;
  ...
  ngOnInit(): void {
    ...
    loginName: new FormControl('',[Validators.minLength(3), Validators.maxLength(15),nameValidator(),Validators.required]),
